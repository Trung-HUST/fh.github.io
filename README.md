...
This repository is also packaged as an AG Kit workspace so AI assistants can reuse the same rules and skills after cloning.

- Root entrypoints: [AGENTS.md](AGENTS.md) and [copilot-instructions.md](copilot-instructions.md)
- Main source of truth: [.agents/ARCHITECTURE.md](.agents/ARCHITECTURE.md)
- Skill/rule bundle: [.agents/](.agents)
...
If you already cloned this repo, you usually do not need to run it again unless you want to refresh the AG Kit bundle from upstream.

### Reuse Checklist

- Keep `.agents/` in the repository so editors can index it.
- Do not add secret values to agent instructions.
...
```bash
# Clone
git clone https://github.com/Trung-HUST/fh.github.io
cd matrix
...
[MIT](./LICENSE) © 2026 Trunghere

## User note
 npm --prefix "c:\Users\PT\Downloads\dev\dashboard\matrix" run dev
 npm --prefix "C:\Users\Glucose\Documents\fh.github.io" run dev   // máy tính ở nhà
 cài https://github.com/vudovn/ag-kit , làm sao để tối ưu cho các model AI đọc và follow theo rule và skill 