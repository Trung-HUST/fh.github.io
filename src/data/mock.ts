...
export const transactions: Transaction[] = [
  { id: "100", name: "Vốn tự có ban đầu", category: "Bank Account", amount: 65100000, date: "2026-01-01", status: "Completed" },
  { id: "101", name: "Nhận tiền vay nợ", category: "Bank Account", amount: 120000000, date: "2026-02-01", status: "Completed" },
  { id: "102", name: "Trả nợ thay mẹ", category: "Bank Account", amount: -120000000, date: "2026-02-01", status: "Completed" },
  { id: "103", name: "Ghi nhận nợ mẹ", category: "Accounts Receivable", amount: 60000000, date: "2026-02-01", status: "Completed" },
  { id: "104", name: "Mẹ trả nợ tháng 1", category: "Bank Account", amount: 5000000, date: "2026-03-01", status: "Completed" },
  { id: "105", name: "Giảm khoản phải thu", category: "Accounts Receivable", amount: -5000000, date: "2026-03-01", status: "Completed" },
  { id: "106", name: "Mẹ trả nợ tháng 2", category: "Bank Account", amount: 5000000, date: "2026-04-01", status: "Completed" },
  { id: "107", name: "Giảm khoản phải thu", category: "Accounts Receivable", amount: -5000000, date: "2026-04-01", status: "Completed" },
  { id: "108", name: "Tích lũy trả nợ tháng 1", category: "Bank Account", amount: -20000000, date: "2026-05-01", status: "Completed" },
  { id: "109", name: "Trả nợ gốc (1)", category: "Liabilities", amount: 20000000, date: "2026-05-01", status: "Completed" },
  { id: "110", name: "Tích lũy trả nợ tháng 2", category: "Bank Account", amount: -20000000, date: "2026-06-01", status: "Completed" },
  { id: "111", name: "Trả nợ gốc (2)", category: "Liabilities", amount: 20000000, date: "2026-06-01", status: "Completed" },
  { id: "112", name: "Tích lũy trả nợ tháng 3", category: "Bank Account", amount: -20000000, date: "2026-07-01", status: "Completed" },
  { id: "113", name: "Trả nợ gốc (3)", category: "Liabilities", amount: 20000000, date: "2026-07-01", status: "Completed" },
];
...
export const goals: Goal[] = [
  { name: "Emergency Fund", target: 50000000, saved: 0, icon: "shield" },
  { name: "Vacation Trip", target: 10000000, saved: 0, icon: "plane" },
  { name: "Liabilities", target: 120000000, saved: 60000000, icon: "car" },
  { name: "Home Down Payment", target: 1000000000, saved: 0, icon: "home" },
];
...
export const biometrics = Array.from({ length: 30 }, (_, i) => {
  const d = new Date();
  d.setDate(d.getDate() - (29 - i));
  return {
    date: d.toISOString().split('T')[0],
    sleepScore: Math.floor(60 + Math.random() * 40),
    sleepDuration: 5 + Math.random() * 4,
    steps: Math.floor(3000 + Math.random() * 12000),
    calories: Math.floor(1500 + Math.random() * 1500)
  };
});
